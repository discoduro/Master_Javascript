...
var controllerContact = {
    ...
    // #1 ruta de prueba
    homePrueba: function(req, res){
        return res.status(200).send({
            message:'Soy accion home del componente contact'
        });
    },
    ...
    saveContact: function(req, res){
        ...
        contact.fecha = params.fecha;
        contact.asunto =  params.asunto;
        contact.correo = params.correo;
        contact.mensaje = params.mensaje;
